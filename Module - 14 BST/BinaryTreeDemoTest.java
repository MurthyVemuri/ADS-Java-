...
/*
	...
	private NodeValue deleteValue(NodeValue root , int data) {
       NodeValue temp,curRoot;
       if (root.getValue() == data) {
           ...
           root.setLeft( deleteValue(root.getLeft(),data) );
       } else if(data > root.getValue()){
           root.setRight( deleteValue(root.getRight(),data) );
       }
       return root;
   } 
*/
